    ...
    while(!WindowShouldClose()){
        ...
        if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT)){
            ...
            if (!pieza_seleccionada){
                ...
                //validar torres
                else if (tab[org_f][org_c].sbl == 'T' || tab[org_f][org_c].sbl == 't'){
                    if (vltr_torre(tab, org_f, org_c, chg_f, chg_c) == 1){
                        mov_valido = false;
                    }
                }
                //validar caballos
                else if (tab[org_f][org_c].sbl == 'C' || tab[org_f][org_c].sbl == 'c'){
                    if (vltr_cbll(tab, org_f, org_c, chg_f, chg_c) == 1){
                        mov_valido = false;
                    }
                }
                //validar alfiles
                else if (tab[org_f][org_c].sbl == 'A' || tab[org_f][org_c].sbl == 'a'){
                    if (vltr_alfl(tab, org_f, org_c, chg_f, chg_c) == 1){
                        mov_valido = false;
                    }
                }
                //validar rey
                else if (tab[org_f][org_c].sbl == 'K' || tab[org_f][org_c].sbl == 'k'){
                    if (vltr_rey(tab, org_f, org_c, chg_f, chg_c) == 1){
                        mov_valido = false;
                    }
                }
                //validar reina
                else if (tab[org_f][org_c].sbl == 'Q' || tab[org_f][org_c].sbl == 'q'){
                    if (vltr_reina(tab, org_f, org_c, chg_f, chg_c) == 1){
                        mov_valido = false;
                    }
                }
